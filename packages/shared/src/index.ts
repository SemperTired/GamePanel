...
export const rolePermissions: Record<Role, Permission[]> = {
  ...
  staff: ["admin:access", "users:read", "services:read", "services:write", "services:power", "services:console", "services:files", "services:mods", "templates:read", "billing:read", "audit:read"],
