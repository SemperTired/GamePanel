...
export const rolePermissions: Record<Role, Permission[]> = {
  ...
  staff: ["admin:access", "users:read", "services:read", "services:write", "services:power", "services:console", "services:files", "services:mods", "templates:read", "nodes:read", "docker:read", "infrastructure:read", "billing:read", "audit:read"],
